...
public class SchemeSyntaxRulesExpressionImpl extends ASTWrapperPsiElement implements SchemeSyntaxRulesExpression {

  public SchemeSyntaxRulesExpressionImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SchemeVisitor visitor) {
    visitor.visitSyntaxRulesExpression(this);
  }
