...
public class SchemeLetrecSyntaxExpressionImpl extends ASTWrapperPsiElement implements SchemeLetrecSyntaxExpression {

  public SchemeLetrecSyntaxExpressionImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SchemeVisitor visitor) {
    visitor.visitLetrecSyntaxExpression(this);
  }
