...
public class SchemeConstantImpl extends ASTWrapperPsiElement implements SchemeConstant {

  public SchemeConstantImpl(ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public SchemeNil getNil() {
    return findChildByClass(SchemeNil.class);
  }
